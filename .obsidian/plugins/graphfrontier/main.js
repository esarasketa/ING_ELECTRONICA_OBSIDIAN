  ...
  "src/view.js"(exports2, module2) {
    ...
    var GraphFrontierView2 = class extends ItemView {
      ...
      buildSidePanel() {
        ...
        this.addSideSlider(displaySection, "Edge width", "edge_width_scale", 0.01, edge_width_scale_MAX, 0.01, "render", {
...
module.exports = class GraphFrontierPlugin extends Plugin {
  ...
  normalizeData(data) {
    ...
    normalized.settings.edge_width_scale = this.clampNumber(normalized.settings.edge_width_scale, 0.01, edge_width_scale_MAX, DEFAULT_DATA.settings.edge_width_scale);
