...
Su eje real, es el reciproco de la resistencia, la conductancia.
$\Large G = \frac{1}{R}$

Su eje imaginario, la susceptancia, se comporta inversamente, pero de forma individual, a la reactancia:   
$\Large B = B_C - B_L = \omega C - \frac{1}{\omega L}$
